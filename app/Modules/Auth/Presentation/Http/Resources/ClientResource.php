    ...
    public function toArray($request): array
    {
        return [
            ...
            'address' => $this->resource->getAddress() ? [
                'country' => $this->resource->getAddress()->getCountry(),
                'region' => $this->resource->getAddress()->getRegion(),
                'city' => $this->resource->getAddress()->getCity(),
                'street' => $this->resource->getAddress()->getStreet(),
                'postal_code' => $this->resource->getAddress()->getPostalCode(),
