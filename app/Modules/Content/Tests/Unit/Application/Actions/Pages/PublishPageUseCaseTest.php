...
class PublishPageUseCaseTest extends TestCase
{
    use MockPermission;

    private PageRepositoryInterface $pageRepo;
    private PublishPageUseCase $useCase;
    ...
    protected function setUp(): void
    {
        ...
        $this->useCase = new PublishPageUseCase($this->pageRepo);
    }
    ...
    #[Test]
    public function publishes_page_successfully(): void
    {
        ...
        $this->useCase->execute(42, $this->mockUserPermission(edit: true));
